    ...
    $.scrollify({
        ...
        afterRender:function() {
          ...
          $(".panel").each(function(i) {
            ...
            pagination += "<li><a data-count=\""+Paginationcount+ "\" class=\"" + activeClass + "\" href=\"#" + $(this).attr("data-section-name") + "\"><span class=\"hover-text\">" + $(this).attr("data-section-name").charAt(0).toUpperCase() + $(this).attr("data-section-name").slice(1) + "</span></a></li>";
            Paginationcount++;
          });
    
          pagination += "</ul>";
    
          $(".sections-container").append(pagination);
    
          $(".pagination a").on("click",function() {
            $.scrollify.move($(this).data("count"));
            //$.scrollify.move(1);
          });
